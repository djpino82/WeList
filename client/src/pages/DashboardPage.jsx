        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {usuario?.rol === 'admin' && (
              <Link
                to="/admin/usuarios"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-brand-50 flex items-center justify-center text-brand-600 hover:bg-brand-100 transition-colors"
                      ...
                      <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-surface-100">
                        <div className="flex items-center gap-3 text-surface-400">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs sm:text-sm">{lista._count?.elementos || 0}</span>
                          </div>
                          {(lista._count?.colaboradores || 0) > 0 && (
                            <div className="flex items-center gap-1.5">
                              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                              </svg>
                              <span className="text-xs sm:text-sm">{lista._count.colaboradores}</span>
                            </div>
                          )}
                        </div>
