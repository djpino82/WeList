      ...
      <nav className="fixed top-0 left-0 right-0 z-40 glass">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold text-xl text-surface-800">WeList</span>
          </Link>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-100/50 rounded-full mb-8 animate-fade-in">
              ...
              <span className="text-sm font-medium text-brand-700">Colaboración en tiempo real</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-surface-500 mb-10 max-w-2xl mx-auto text-balance animate-slide-up stagger-1">
              Crea listas colaborativas, comparte con quien quieras y ve los cambios al instante.
              La forma más simple de organizar lo que importa.
            </p>
            ...
            <div className="mt-12 animate-fade-in stagger-3">
              <p className="text-surface-400 text-sm italic max-w-md mx-auto">
                "La mejor herramienta para organizar a mi equipo. No sabía que necesitaba esto hasta que lo probé."
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 lg:mt-24 relative max-w-5xl mx-auto animate-slide-up stagger-4">
              ...
              <div className="rounded-2xl bg-surface-100 p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="ml-4 flex-1 h-8 bg-white rounded-lg flex items-center px-3">
                    <span className="text-xs text-surface-400">welist.app/dashboard</span>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="col-span-2 bg-white rounded-xl p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="font-semibold text-surface-800">Lista de compras</h4>
                      <span className="badge">3 personas</span>
                    </div>
                    {['Leche', 'Pan', 'Huevos', 'Frutas'].map((item, i) => (
                      <div key={item} className="flex items-center gap-3 p-2 rounded-lg hover:bg-surface-50">
                        <div className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center ${
                          i < 2 ? 'bg-brand-500 border-brand-500' : 'border-surface-300'
                        }`}>
                          {i < 2 && (
                        ...
                        <span className={`text-sm ${i < 2 ? 'text-surface-400 line-through' : 'text-surface-700'}`}>
                          {item}
                        </span>
                      </div>
                    ))}
            ...
            <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-brand-100 rounded-2xl -rotate-12 animate-float" style={{ animationDelay: '1s' }} />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-surface-500 max-w-2xl mx-auto">
              Diseñado para ser simple pero potente. Sin funcionalidades innecesarias,
              solo lo que realmente necesitas para organizarte.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card group">
              ...
              <p className="text-surface-500">
                Crea listas y compártelas con quien quieras. Amigos, familia o equipo de trabajo, todos al mismo nivel.
              </p>
            </div>
            ...
            <div className="card group">
              ...
              <p className="text-surface-500">
                Los cambios se sincronizan al instante. Cuando alguien marca un elemento, todos lo ven inmediatamente.
              </p>
            </div>
            ...
            <div className="card group">
              ...
              <p className="text-surface-500">
                Interfaz limpia y fácil de usar. Sin complicaciones, sin curva de aprendizaje. Solo abre y usa.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-32 bg-white relative">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: '01', title: 'Crea tu cuenta', desc: 'Regístrate gratis en segundos. Sin tarjetas, sin compromisos.' },
              { step: '02', title: 'Crea una lista', desc: 'Dale un nombre, invita a quien quieras y empieza a añadir elementos.' },
              { step: '03', title: 'Organiza junto', desc: 'Marca elementos, ve cambios en tiempo real y mantente sincronizado.' },
            ].map((item, i) => (
              <div key={item.step} className="text-center relative">
                <div className="font-display text-6xl font-bold text-brand-100 mb-4">{item.step}</div>
                <h3 className="font-display text-xl font-semibold text-surface-800 mb-2">{item.title}</h3>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-brand-100 text-lg mb-10 max-w-xl mx-auto">
              Empieza a organizar tu vida hoy. Es gratis, rápido y sin complicaciones.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-semibold text-white">WeList</span>
            </div>
            <div className="flex items-center gap-8">
              <Link to="/login" className="text-surface-400 hover:text-white transition-colors text-sm">
                Iniciar sesión
              </Link>
              <Link to="/registro" className="text-surface-400 hover:text-white transition-colors text-sm">
                Registrarse
              </Link>
            </div>
